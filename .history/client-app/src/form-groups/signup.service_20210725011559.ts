...
export class SignUpFormGroup {
    ...
    getFormGroup(user?: Signup): FormGroup {
        return this.fb.group({
            ...
            projectName: [user?.projectName, [Validators.maxLength(50), Validators.minLength(4)]],
            teamName: [user?.teamName, [Validators.required, Validators.minLength(4), Validators.maxLength(50)]],
        }
        );
    }
