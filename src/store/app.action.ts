...
const convertErrorToBug = createAction(
    '[app] convert Error To Bug',
    (errorId: string, userId: string, name: string) => ({ errorId, userId, name })
);

const convertErrorToBugSuccess = createAction(
    '[app] convert Error To Bug Success',
    (errorId: string) => ({ errorId })
);
